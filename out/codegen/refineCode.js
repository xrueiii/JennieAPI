...
exports.refineInsertedCode = refineInsertedCode;
 ...
 */
async function refineInsertedCode(insertedCode, fullContextCode) {
    const prompt = `
...
⚠️ Important: Your response must contain only the final code, without any explanations, comments, or code block markers like \`\`\`.
  `;
    return await (0, azureAI_1.generateResponse)(prompt);
}
//# sourceMappingURL=refineCode.js.map